 ...
 */
class Version20171218100640 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE golden_book ADD author INT NOT NULL, DROP author_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE golden_book ADD author_id INT DEFAULT NULL, DROP author');
